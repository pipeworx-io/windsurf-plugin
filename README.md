...
Connect Windsurf (Cascade) to live data from **2,869 tools across 633 packs** — SEC filings, USPTO patents, FRED economic data, FDA drug data, Census, EPA, ATTOM real estate, weather, and 625+ more.
...
The install loads **17 meta-tools** from the Pipeworx gateway — not all 2,869 underlying tools. That's deliberate: dumping every tool definition into the context window burns tokens you'll never use.
